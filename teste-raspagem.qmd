...
`$profiles[[1]]$viewer$knownFollowers` -> informações sobre os seguidores em comum

`$profiles[[1]]$viewer$knownFollowers$count` -> conta seguidores em comum com o auth
